...
=======
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="tel" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone', auth()->user()->phone) }}" autocomplete="tel">
                                @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
>>>>>>> 138f8d0ba887d993fb88daa0200aaf4b323c2c0b
                                    </span>
                                @enderror
                            </div>
                        </div>
