...
<div class="cards-page">
    ...
    <div class="cards-container" id="cards-container">
        <div class="cards-stack" id="cards-stack">
            ...
            <div class="card-item" data-user-id="<?php echo e($user->id); ?>" style="z-index: <?php echo e(count($users) - $index); ?>;">
                <div class="card-content">
                    <div class="card-photo-container">
                        <img 
                            class="card-photo" 
                            src="" 
                            data-photos='<?php echo e(json_encode($user->albums->flatMap(function($album) {
                        ...
                        <div class="card-overlay">
                            <div class="user-info">
                                <img src="<?php echo e($user->avatar_url); ?>" class="user-avatar">
                                <div class="user-details">
                                    <span class="user-name"><?php echo e($user->nickname); ?></span>
                                    <span class="user-meta"><?php echo e($user->age); ?>岁 · <?php echo e($user->location); ?></span>
                                </div>
                            </div>
                        </div>

                        <div class="photo-counter">
                            <span id="photo-counter-<?php echo e($user->id); ?>">1 / 1</span>
                        </div>

                        <div class="locked-badge" id="locked-badge-<?php echo e($user->id); ?>" style="display: none;">
                            <i class="fas fa-lock"></i>
                            <span>付费解锁</span>
                        </div>

                        <div class="blur-overlay" id="blur-overlay-<?php echo e($user->id); ?>" style="display: none;"></div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Volumes/MyWork/APP/ChatMeGo/resources/views/discover/cards.blade.php ENDPATH**/ ?>